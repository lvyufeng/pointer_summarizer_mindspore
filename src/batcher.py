...
class Batcher(object):
    ...
    def next_batch(self):
        ...
        if self._batch_queue.qsize() == 0:
            logging.warning('Bucket input queue is empty when calling next_batch. Bucket queue size: %i, Input queue size: %i',
